    ...
    return (
        <div className="container-fluid p-0 bg-light" style={{overflow:'hidden'}}>
          ...
          <div style={{marginTop: '9vh', height: '55vh', backgroundSize: 'cover', backgroundPosition: 'center', backgroundImage: `url(${background})`}} className=''>
             <div className=''>
                <blockquote className='lead text-center text-white' style={{paddingTop: '200px'}}>Some interesting articles relating to all sorts of biases, for your knowledge and reading.</blockquote>
             </div>
...
// const root = ReactDOM.createRoot(document.getElementById('root')!);   // notice the '!'
