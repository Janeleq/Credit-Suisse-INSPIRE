...
import footerBackground from '../assets/footerBg.jpg'
    ...
    <div className="container-fluid mt-5 p-0" style={{overflow: 'hidden'}}>
        ...
        <div className='row' style={{marginTop: '3vh'}}>
            <div className='col' style={{backgroundImage: `url(${footerBackground})`, backgroundSize: 'cover'}}>
                ...
                <p className='text-center lead'>Have any doubts or enquiries? Drop us an email! </p>
                <br/>
            ...
            <form onSubmit={onSubmit} className='w-25 mx-auto' style={{height: '70vh'}}>
                <div className="mb-3">
                ...
                <textarea className="form-control" id="message" rows={5} maxLength={250} required />
                </div>
