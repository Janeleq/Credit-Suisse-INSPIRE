            ...
            <div className="row bg-light mx-auto text-center" style={{marginTop: '15vh'}}>
               ...
               <h2 className='lead'>
                  <img src={outcomeIcon} alt="outcome" style={{width: '3%'}}/> &nbsp;
                   Outcome / Consequence of your action <br/> <span className='text-muted' style={{marginLeft: '-2%'}}>{favorable}</span></h2>
              ...
              <p className='lead mt-4'><img src={actionIcon} alt="action" style={{width: '3%'}}/>&nbsp;Choose your next action.</p>
              <br/>
                <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2" onClick={event => handleChoice(event, [1, "You have chosen to mediate between Emma and John, encouraging open dialogue between them, and getting rid of potential bias."])}>
                    <div className="team text-center rounded p-3 py-4 w-75 h-75 mx-auto">
                        <img src={mediateIcon} style={{width: '279px', height: '279px'}} className="img-fluid avatar avatar-medium shadow rounded-pill" alt=""/>
                ...
                <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2" onClick={event => handleChoice(event, [2, "You have chosen to side with one team member based on personal bias."])}>
                    <div className="team text-center rounded p-3 py-4 w-75 h-75 mx-auto">
                        <img src={sideIcon} style={{width: '279px', height: '279px'}} className="img-fluid avatar avatar-medium shadow rounded-pill" alt=""/>
                        <div className="content mt-3">
                ...
                <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2" onClick={event => handleChoice(event, [3, "You have chosen to ignore the conflict between both Emma and John, and hope it resolves itself."])}>
                    <div className="team text-center rounded p-3 py-4 w-75 h-75 mx-auto">
                        <img src={ignoranceIcon} style={{width: '279px', height: '279px'}} className="img-fluid avatar avatar-medium shadow rounded-pill" alt=""/>
                        <div className="content mt-3">
