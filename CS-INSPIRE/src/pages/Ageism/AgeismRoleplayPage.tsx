            ...
            <div className="row" style={{marginTop: '9vh'}}>
                ...
                <div className="col-sm-12 col-md-8 col-lg-6 text-center bg-white" style={{height: '120vh'}}>
                  ...
                  <div className='col'>
                    ...
                    <p className='mb-0'>Take up a roleplay to learn and explore more about Ageism!</p>
                    ...
                    <div className='guide mx-auto text-muted mt-3'>
                      <div className='row'>
                        ...
                        <br/>
                        <button className='mx-auto text-center' onClick={AgeismRoleplay}>Start Roleplay</button>
                    </div> 
                  </div>
                </div>
                <br/><br/>
