        ...
        <div className="row">
          <div className="col">
            ...
            <p className="text-center w-50 mx-auto">
              ...
              decision-making processes. These biases are deeply rooted in
            ...
            >
              ...
              <div className="col-sm-6 col-lg-4">
                <div className="w-75 h-75 text-center">
                  ...
                  <img src="" className="w-75 h-75" />
                  <p className="w-75" style={{ marginLeft: "12%" }}>
                    The tendency for positive impressions of a person, company,
                    country, brand, or product in one area to positively or
                    negatively influence one's opinion or feelings in other
                    areas
                  </p>
                </div>
              </div>
        ...
        <div className="row">
          ...
          >
            ...
            <p className="w-50 text-center mx-auto">
              ...
              us remember that awareness is the catalyst for transformation. By
              acknowledging our biases, engaging in self-reflection, and
