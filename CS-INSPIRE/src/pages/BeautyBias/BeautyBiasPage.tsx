...
function Beautybias() {
    ...
    <div className="row" style={{marginTop: '9vh'}}>
        <div className='col-sm-12 col-md-4 col-lg-6' style={{backgroundImage:`url(${background})`, backgroundSize: 'cover', height: '140vh'}}>

        </div>

        <div className="col-sm-12 col-md-8 col-lg-6 text-center bg-white" style={{height: '140vh'}}>
            <div className="section-title mt-5">
                <h4>Unconscious Bias: <mark>Beauty Bias</mark></h4>
            ...
            In the realm of beauty bias, it's essential to recognize that societal standards and media portrayals often influence our perceptions of what is considered 'beautiful' or 'attractive.' These standards can inadvertently influence how we perceive individuals, including their credibility, intelligence, and worth.
                ...
                <div className='row'>
                  <div className='col'>
                    ...
                    <p className='mb-0'>Take up a roleplay to learn and explore more about Beauty Bias!</p>
                    ...
                    <div className='guide mx-auto text-muted mt-3'>
                     ...
                     4     <small className=''>view the consequence of your action</small>
                        </div>
                      </div>
                        <br/>
                ...
                <div className='row'>
                  <div className='col'>
                      ...
                      <div className='guide w-50 mx-auto'>
                        ...
                        <button type="" onClick={beautyBiasRoleplay}>View statistics</button>
                      </div> 
                    </div>
                </div>
                <br/><br/>
